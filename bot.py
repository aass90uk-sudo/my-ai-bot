...
async def longing_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    for user_id in [ABDULRAHMAN_ID, HANEEN_ID]:
        ...
        # إذا ما تكلمناش معاه أبداً أو مضات ساعة — نرسلو رسائل الاشتياق
...
if __name__ == '__main__':
    ...
    # يبدأ فوراً بعد دقيقة واحدة من التشغيل، ويكرر كل ساعة
    application.job_queue.run_repeating(
        longing_job,
        interval=LONGING_INTERVAL,
        first=60,   # دقيقة واحدة بعد التشغيل ثم كل ساعة
    )
